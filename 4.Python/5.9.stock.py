...
if __name__ == "__main__":
    data = open(r"/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/4.Python/SH600000.txt",
                "rb").read()
    print(chardet.detect(data))
    stock_max, stock_min, stock_close, stock_amount = np.loadtxt('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/4.Python/SH600000.txt',encoding='GB2312',delimiter='\t', skiprows=2, usecols=(2, 3, 4, 5), unpack=True)
    N = 100
