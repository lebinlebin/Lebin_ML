...
def convolve(image, weight):
    ...
    for i in range(height_new):
        for j in range(width_new):
            image_new[i,j] = np.sum(image[i:i+h, j:j+w] * weight)#按位置相乘即可
...
if __name__ == "__main__":
    A = Image.open("/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/5.Package/son.png", 'r')
    output_path = '/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/5.Package/'
