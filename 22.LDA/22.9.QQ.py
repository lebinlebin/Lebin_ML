...
def load_stopword():
    f_stop = open('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/22.LDA/stopword.txt')
...
def load_stopwords():
    stopwords = set()
    f = open('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/22.LDA/stopword.txt', encoding='GBK')
    for w in f:
...
if __name__ == '__main__':
    ...
    regularize_data('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/22.LDA/QQChat.txt')
    print('segment')
    segment()
    print('combine')
    combine()
