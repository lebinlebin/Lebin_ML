...
def load_stopwords():
    f = open('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/22.LDA/stopword.txt')
    for w in f:
...
if __name__ == "__main__":
    stopwords = set()
    load_stopwords()
    input_dir = '/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/22.LDA/200806/'
