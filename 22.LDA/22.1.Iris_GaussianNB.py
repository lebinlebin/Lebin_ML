...
if __name__ == "__main__":
    ...
    if data_type == 'car':
        ...
        data = pd.read_csv('/Users/liulebin/Documents/codeing/codeingForSelfStudy/ML-Basic-Theory-Study/ML_Learning_code/9.Regression/iris.data', header=None, names=feature_names)
